...
public class CreateNodeWithACLDemo implements Watcher {
    ...
    private void doSomeThing() throws KeeperException, InterruptedException, NoSuchAlgorithmException {
        ...
        ACL aclIdOne = new ACL(ZooDefs.Perms.ALL, new Id("ip", "127.0.0.1"));
        ...
        // 在zookeeper客户端端中只能使用digest,不能使用auth，world
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        zooKeeper = new ZooKeeper("localhost:2181", 5000, new CreateNodeWithACLDemo());
