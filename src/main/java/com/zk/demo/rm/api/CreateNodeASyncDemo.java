...
public class CreateNodeASyncDemo implements Watcher {
    ...
    public void process(WatchedEvent event) {
        if (event.getState() == Event.KeeperState.SyncConnected) {
            ...
            zooKeeper.create("/java_node_2", "我是data".getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT , new MyStringCallback(), "我是传输的数据!");
     ...
     *
     * @date 2019/01/06 18:07
     */
    public static void main(String[] args) throws IOException, InterruptedException {
        zooKeeper = new ZooKeeper("localhost:2181", 5000, new CreateNodeASyncDemo());
